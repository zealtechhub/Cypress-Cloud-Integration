    ...
    <React.Fragment>
      <div className="drawer-container bg-white h-32 fixed z-[999]">
        <IconButton
          ...
          size="large"
          className="toggle-bt !absolute top-5 left-5 !bg-white shadow-2xl"
        >
        ...
        >
          <div className="drawer-content !bg-primary/10 h-full py-3 w-[300px]">
            <CardActionArea tabIndex={-1} onClick={_c.bind(false)}>
              <NavLink to={"profile"} className="!outline-none !border-none">
                <div
                  title="profile link"
            ...
            {ListItems.map((item) => (
              <CardActionArea
                tabIndex={-1}
                onClick={_c.bind(false)}
                key={item.path}
              >
                <NavLink to={item.path} className="!outline-none !border-none">
                  <div className="flex items-center gap-x-3 p-2 py-4 border-b border-gray-300">
